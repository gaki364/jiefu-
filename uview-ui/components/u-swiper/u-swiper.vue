<template>
	<view class="u-swiper-wrap" :style="{
		...
		<swiper :vertical="vertical" :current="elCurrent" @change="change" @animationfinish="animationfinish" :interval="interval" :circular="circular" :duration="duration" :autoplay="autoplay"
...
<style lang="scss" scoped>
	...
	.u-indicator-item-rect {
		...
		margin: 0 6rpx;
		transition: all 0.5s;
		background-color: rgba(#979797, 1);
	}

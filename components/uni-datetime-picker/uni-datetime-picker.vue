<template>
	<view class="uni-date">
			...
			<slot>
				<view class="uni-date-editor--x" :class="{'uni-date-editor--x__disabled': disabled,'uni-date-x--border': border}">
					...
					<view v-else class="uni-date-x uni-date-range">
						...
						<image :src="gAssets.idx2_jt" class="range-separator" style="width: 57rpx;" mode="widthFix"></image>

						<view class="uni-date__x-input text-center">{{ displayRangeValue.endDate || endPlaceholderText }}</view>
						<image :src="gAssets.idx2_rqi" class="range-separator" style="width: 57rpx; margin-right: 30rpx;" mode="widthFix"></image>
					</view>
		...
		<view v-if="!isPhone" v-show="pickerVisible" ref="datePicker" class="uni-date-picker__container">
			<view v-if="!isRange" class="uni-date-single--x" :style="pickerPositionStyle">
				...
				<view v-if="hasTime" class="uni-date-changed popup-x-header">
					...
					<time-picker type="time" v-model="pickerTime" :border="false" :disabled="!inputDate" :start="timepickerStartTime"
					 :end="timepickerEndTime" :hideSecond="hideSecond" style="width: 100%;">
						<input class="uni-date__input text-center" type="text" v-model="pickerTime" :placeholder="selectTimeText"
						 :disabled="!inputDate" />
					</time-picker>
				</view>

				<Calendar ref="pcSingle" :showMonth="false" :start-date="calendarRange.startDate" :end-date="calendarRange.endDate"
				 :date="calendarDate" @change="singleChange" :default-value="defaultValue" style="padding: 0 8px;" />
			...
			<view v-else class="uni-date-range--x" :style="pickerPositionStyle">
				...
				<view v-if="hasTime" class="popup-x-header uni-date-changed">
					<view class="popup-x-header--datetime">
						...
						<time-picker type="time" v-model="tempRange.startTime" :start="timepickerStartTime" :border="false" :disabled="!tempRange.startDate"
						 :hideSecond="hideSecond">
							<input class="uni-date__input uni-date-range__input" type="text" v-model="tempRange.startTime" :placeholder="startTimeText"
					...
					<view class="popup-x-header--datetime">
						...
						<time-picker type="time" v-model="tempRange.endTime" :end="timepickerEndTime" :border="false" :disabled="!tempRange.endDate"
						 :hideSecond="hideSecond">
							<input class="uni-date__input uni-date-range__input" type="text" v-model="tempRange.endTime" :placeholder="endTimeText"
				...
				<view class="popup-x-body">
					<Calendar ref="left" :showMonth="false" :start-date="calendarRange.startDate" :end-date="calendarRange.endDate"
					 :range="true" :pleStatus="endMultipleStatus" @change="leftChange" @firstEnterCale="updateRightCale" style="padding: 0 8px;" />
					<Calendar ref="right" :showMonth="false" :start-date="calendarRange.startDate" :end-date="calendarRange.endDate"
					 :range="true" @change="rightChange" :pleStatus="startMultipleStatus" @firstEnterCale="updateLeftCale" style="padding: 0 8px;border-left: 1px solid #F1F1F1;" />
				</view>
		...
		<Calendar v-if="isPhone" ref="mobile" :clearDate="true" :date="calendarDate" :defTime="mobileCalendarTime"
		 :start-date="calendarRange.startDate" :end-date="calendarRange.endDate" :selectableTimes="mobSelectableTime"
		 :startPlaceholder="startPlaceholder" :endPlaceholder="endPlaceholder" :default-value="defaultValue" :pleStatus="endMultipleStatus"
		 :showMonth="false" :range="isRange" :hasTime="hasTime" :insert="false" :hideSecond="hideSecond" @confirm="mobileChange"
		 @maskClose="close" />
	</view>
</template>
<script>
	...
	export default {
		...
		computed: {
			...
			showClearIcon() {
				return this.clearIcon && !this.disabled && (this.displayValue || (this.displayRangeValue.startDate && this.displayRangeValue
					.endDate))
			}
		},
		created() {
